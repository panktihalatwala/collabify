...
class InfluencerProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'languages': forms.TextInput(attrs={'class': INPUT_CLASS, 'placeholder': 'e.g. English, Hindi'}),
            ...
            'tiktok_url': forms.URLInput(attrs={'class': INPUT_CLASS, 'placeholder': 'https://tiktok.com/...'}),
